...
{
    public class MaterialUseOutStoreReturnViewModel : BaseViewModel, IMasterViewModel,IDataStatusViewModel
    {
        ...
        public IEnumerable<MaterialUseOutStoreReturnDetailViewModel> Details { get; set; }
    }

    public class MaterialUseOutStoreReturnDetailViewModel : IBaseViewModel
    {
